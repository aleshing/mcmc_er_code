...
This repository contains code used to reproduce the illustrative example in the manuscript "Monitoring Convergence Diagnostics for Entity Resolution: A Review and Proposed Workflow for Practitioners" by Serge Aleshin-Guendel and Rebecca C. Steorts. The structure of this repository is as follows:
